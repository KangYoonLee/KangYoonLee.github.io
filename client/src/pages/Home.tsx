...
const researchKeywords = ["Datacenter Networking", "Causal Modeling", "Traffic Dynamics"];
      ...
      <main id="home">
        <section className="hero">
          <div className="hero-intro-layout">
            ...
            <div className="research-keywords" aria-label="Research areas">
              {researchKeywords.map((keyword) => <span key={keyword}>{keyword}</span>)}
            </div>
            <p className="bio">I&apos;m a first year Ph.D. student in the Department of Computer Science at <a href="https://engineering.jhu.edu/" target="_blank" rel="noreferrer">Johns Hopkins University</a> advised by <a href="http://soudeh.net/#home" target="_blank" rel="noreferrer">Dr. Soudeh Ghorbani</a>. Before joining JHU, I worked as a Research Intern (Data Engineer) at the AI and Robotics Institute of the <a href="https://www.kist.re.kr/eng/" target="_blank" rel="noreferrer">Korea Institute of Science and Technology</a> (KIST)and I received my B.Eng. in Information and Communications Engineering from <a href="https://www.hufs.ac.kr/" target="_blank" rel="noreferrer">Hankuk University of Foreign Studies</a> (HUFS).</p>
            <p className="bio">My research asks an one question: <strong>where do traffic bursts actually come from?</strong> In AI training datacenters, bursts are treated as something to react to — yet why they form, and at which layer of the network stack, remains poorly understood. I trace the causal origins of these bursts across the stack, from collective communication down to the NIC and switch fabric, building the domain knowledge that lets operators anticipate congestion rather than merely respond to it.</p>
          </div>
